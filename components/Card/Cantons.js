...
const Parlament = props => (
  <svg width={props.size} height={props.size} viewBox='0 0 1150 1150' {...props}>
    <rect width='1150' height='1150' fill='#fff' />
    <g transform='translate(175 48)'>
      <path d='M395.5 562.5v95.7H198.9v174.2h196.6V1030h182.1V832.4h193.6V659.1' fill='none' stroke='#000' stroke-width='20' />
