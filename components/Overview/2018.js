...
export default {
  Januar: (p) => <Fragment>
    Die Republik geht mit <Highlight {...p} ids={['ByKAxDA8c0Zm', 'Bkm0xwA89AbX']}>irrational langen Beiträgen</Highlight> an den Start. Auftakt für den <Highlight {...p} ids={['BJn6eD0U90-m']} format='republik/format-am-gericht'>Schwerpunkt Justiz</Highlight>. Premiere der ersten Reportagen-Serie «<Highlight {...p} series='republik/article-usa-auftakt'>Race, Class, Guns and God</Highlight>». <Highlight {...p} format='republik/format-bergs-nerds'>Sibylle Berg</Highlight> und <Highlight {...p} format='republik/format-binswanger'>Daniel Binswanger</Highlight> starten ihre Kolumnen. <Highlight {...p} ids={['BJ93gvRI5AWm', 'BkPogDAUcC-7']}>Globi besucht das WEF</Highlight>, wir analysieren Fox News und verteidigen den Service public. <Highlight {...p} ids={['HkNixPCLqCWQ', 'BkzjxvAIq0WQ', 'ByE9evAIqA-m']}>Doping-Recherchen</Highlight> sorgen international für Aufsehen.
  </Fragment>,
  Februar: () => <Fragment>
    Beppe Grillos Fünf-Sterne-Bewegung in Italien, Politwerbung auf Facebook: Digitale Themen werden zu einem Markenzeichen der Republik. Das Elend der SDA und die Zukunft der AHV beschäftigen Debatten wie Autorinnen. Die Audio-Podcasts gehen in Serie. Und <A href='https://www.republik.ch/2018/02/12/sie-wir-und-unser-gemeinsames-unternehmen'>wir haben Ihnen zugehört</A>.
  </Fragment>,
  März: () => <Fragment>
  ...
  August: () => <Fragment>
    Liebe, Sex und LSD, dazu – endlich! – der Start der «<A href='https://www.republik.ch/2018/08/21/ameisen-bevoelkern-die-republik'>Ameisen</A>». Die Österreicherin der Republik, Solmaz Khorsand, hält die Rede zur Nation. Wir erklären alles Wichtige zu den flankierenden Massnahmen. Die Wortkünstlerin Fatima Moumouni im Porträt. Das Community-Projekt «<A href='https://www.republik.ch/2018/08/15/ihre-nachbarin-denkt-anders-als-sie-treffen-sie-sich-zum-gespraech'>Die Schweiz spricht</A>» wird lanciert. Und: Bildergalerien werden eingeführt.
  </Fragment>,
  September: () => <Fragment>
