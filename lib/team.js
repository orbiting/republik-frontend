...
const christian = {
  ...
  description: `In Bayern aufgewachsen, in Konstanz studiert: 16 Semester (Biologie, Geschichte, Germanistik), ohne Abschluss. Danach eher zufällig Redaktor bei den «Kreuzlinger Nachrichten» (damals Zehnder, noch nicht Zehnder-Gruppe, Blocher war weit weg), zwei Jahre später um einiges bewusster zur «Basler Zeitung» (damals ein linksliberales Blatt, Blocher war weit weg), schliesslich 1996 als Herzensangelegenheit zum «Tages-Anzeiger». Als daraus ein Ernährungsprogramm für Besitzerfamilie und Erben wurde und Blocher nahte, wurde es höchste Zeit, zu gehen. Dank der Chance, erst im Social-Media-Team der Ski-WM St. Moritz 2017 mitzuwirken, danach beim Wandermagazin «Bergwelten», fiel der Abschied leichter. Vor allem aber war es an beiden Orten wie eine Rückkehr in gute Zeiten: Die Diskussionen drehten sich um Relevanz der Inhalte; die Chefs hatten Visionen und Strategien, und sie standen immer eindeutig aufseiten ihrer Mitarbeiter; Hierarchien waren unmittelbar mit Kompetenz verbunden. Apropos Kompetenz: Es ergibt schlicht keinen Sinn, mit Andiel über den 1. FC Köln, David Bowie, Christoph Ransmayr, die «Süddeutsche Zeitung» oder den (von seiner Mutter für alle Zeiten definierten) Geschmack von Knödeln, Kartoffelpuffern und Rinderspickbraten mit Rahmsauce streiten zu wollen. (Okay, da ist auch noch Richard Wagner, darüber kann man natürlich reden … wobei «Parsifal» und «Die Walküre» …). Er weiss halt, dass dies alles gut ist. Apropos Grössenwahn: Leidenschaft, Witz, Wut, Transparenz nach innen und aussen, Zuverlässigkeit, Sprachgefühl, Spass, Mut, Offenheit. Und vor allem Empathie. Er weiss genau, was er vom Journalismus erwartet. Und jetzt hat er die Chance, als Chef vom Dienst mitzuhelfen, den Laden bei der Republik so zu schmeissen, dass die Autorinnen und Autoren ihren Job für genau diesen Journalismus so gut wie möglich machen können. Hammer.`,
...
const manuel = {
  ...
  description: `Manuel Erdös hatte bereits in der Primarschule einen Plan. Er wollte Hacker werden. Und möglichst viel Geld verdienen, damit er später mal zur Hälfte IT und zur anderen Hälfte Musik machen kann. Zu seiner grossen Enttäuschung waren die ersten Schritte zur Hackerkarriere in einer im Internet gefundenen Anleitung «Wie wird man Hacker» nicht wie gewünscht in wenigen Minuten zu machen. Bis zum Schritt 3 brauchte man bereits sieben Jahre (Schritt 1 und 2 beinhalteten Grundausbildung und Studium). Schon damals zeigte sich, dass Manuel lieber sofort loslegt, statt zuerst noch über den Büchern zu sitzen. Eine gescheiterte Probezeit im Gymnasium bestätigte das, weshalb er nach der Sekundarschule schliesslich eine Informatikerlehre bei der Universität Zürich absolvierte. Auspubertiert, verlor er sein Hackingbedürfnis, sein Interesse an IT aber nicht. Nach der einjährigen Berufsmaturität arbeitete er wieder an der Universität und startete bald darauf mit dem Informatikstudium. Das öffnete ihm einmal mehr die Augen. Er wollte praktische Arbeit. Und Aufregung. Und Abwechslung. Er hat sich den Wunsch erfüllt. Er brach das Studium ab (was ja zum guten Ton gehört) und arbeitet jetzt bei der Republik. Neben internen IT-Projekten und Audioaufnahmen sorgt er dafür, «dass die technischen Probleme der Mitarbeitenden nicht für schlechte Laune sorgen».`,
...
const michael = {
  ...
  dob: '26.3.1977',
  title: 'Autor',
  description: `Michael Rüegg zäumt Pferde gern mal von hinten auf. Im Alter von 18 Jahren war er Präsident eines nationalen Verbandes. Dieses Amt gab er nach anderthalb Jahren für ein Praktikum im Empfang bei einer PR-Agentur auf. Zum Journalismus gelangte er via Umwege. Erst verkaufte er als Werbetexter ein Jahrzehnt lang Windeln, Anlagefonds und Interkontinentalflüge. Eher zufällig wurde er Mediensprecher der Direktion der Justiz und des Innern des Kantons Zürich. Dort angelangt, war er mit der Qualität der Berichterstattung über «seine» Themen derart unzufrieden, dass er nach vier Jahren als Zürich-Redaktor zur «Aargauer Zeitung» wechselte. Wieder ein paar Jahre später fand er zurück in die politische Kommunikation, diesmal bei der Stadt Zürich. Als die Republik an den Start ging, sagte er sich: «Nirgendwo anders will ich sein.» Michael ist ein polyvalenter Autor. Er schreibt auch regelmässig Theaterstücke, Comedy und kann an guten Tagen Gefühle ohne die Verwendung von Emojis ausdrücken.`,
...
const miriam = {
  ...
  dob: '16.01.1987',
  title: 'Netzwerk-Organisation',
  description: `Miriam Walther wuchs in Brasilien und der Schweiz auf. Sie ist Regisseurin, Produktionsleiterin und Fellow an der Zürcher Hochschule der Künste (ZHdK). Bei der Republik arbeitet sie seit Dezember 2017 im Bereich Community-Development und Netzwerk-Redaktion. Ihr Fokus: Kuration von diversen Veranstaltungen. Ihr gegenwärtiges Hobby ist das Studium der Philosophie und der Politikwissenschaft an der Universität Zürich. Vorher studierte sie zeitgenössischen Tanz an der Alvin Ailey School in New York City (Diplom), Theaterregie an der ZHdK (BA und MA) und als Horizonterweiterung: ein Semester Wirtschaft und Recht an der Universität St. Gallen (HSG). Sie ist Gründungsmitglied des transdisziplinären Kollektivs «Neue Dringlichkeit» und der Initiative «Neue Welt», die jährlich die Un-Conference «Labor mit Utopieverdacht» organisiert. 2015 bis 2017 war sie Co-Leiterin der Zentral-Bühne am Zürcher Theater Spektakel. Seit 2009 realisiert sie mit verschiedenen Kollaborateurinnen Arbeiten in der Schweiz, Russland, Deutschland und Israel. Hinzu kommt ihr kulturpolitisches Engagement: 2013 bis 2017 war sie Vorstandsmitglied von ACT Zürich. 2015 erhielt sie die kulturelle Auszeichnung im Bereich Theater der Stadt Zürich.`,
...
team.sort((a, b) => ascending(a.name, b.name))

admin.forEach(person => {
  person.age = person.dob ? age(person.dob) : person.age
})
admin.sort((a, b) => ascending(a.name, b.name))
