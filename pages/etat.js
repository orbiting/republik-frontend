...
export default withData(
  withT(({ url, t }) => {
    ...
    return (
      ...
      <P>Wir versprechen: Ihre Idee wird vertraulich behandelt. Und sie müssen nicht warten:</P>

      <P>Wir prüfen ihren Vorschlag umgehend. Sie erhalten binnen einer Woche eine Antwort.</P>

      <P>Im schlimmsten Fall ist das ein kurzes: «Leider nein», aber dann verlieren Sie wenigstens keine Zeit.</P>
      ...
      <P>PS: Unser <A href='https://www.republik.ch/2018/01/19/usa-serie'>erster Serienprototyp</A> wurde bereits mit Mitteln aus dem Etat finanziert.</P>
